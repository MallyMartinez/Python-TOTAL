...
Práctica con Variables 1
    ...
    Asigna a la variable nombre el valor "Tony Soprano", 
    y a la edad, el valor 51.
"""
nombre = "Tony Soprano"
edad = 51
...
*   Estás tomando un curso de curso
    Para ello deberás concatenar la primera parte de la frase con el valor que asumirá 
    la variable. Recuerda agregar un espacio antes de concatenar la variable al resto del texto.
"""
curso = "Python"
